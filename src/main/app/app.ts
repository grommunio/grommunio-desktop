    ...
    // update the callback
        ...
        try {
            let result = await dialog.showMessageBox(mainWindow, {
                ...
                message: localizeMessage('main.app.app.handleAppCertificateError.certError.dialog.message', 'There is a configuration issue with this grommunio server, or someone is trying to intercept your connection. You also may need to sign into the Wi-Fi you are connected to using your web browser.'),
                type: 'error',
                detail,
                buttons: [
