...
`
        ...
        fs.appendFileSync(defaultsListPath, 'x-scheme-handler/mattermost-dev=grommunio-desktop-dev.desktop\n');
        ...
        fs.appendFileSync(mimeCachePath, 'x-scheme-handler/mattermost-dev=grommunio-desktop-dev.desktop\n');
